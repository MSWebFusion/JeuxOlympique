...
namespace JeuxOlympique.Helper
{
    public class FonctionUtile
    {
        private static readonly Random Random = new Random();

        public static byte[] GenerateQRCode(string TokenGenerate, ApplicationUser user, Offre offre)
        {
            ...
            contactInfo.Append("Nom : " + user.Nom);
            ...
            using (var bitmap = barcodeWriter.Write(contactInfo.ToString()))
            {
